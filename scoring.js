...
$(document).ready(function () {
  ...
  $('#btn-declaration').click(function () {
    ...
    //let judgmeent_i = document.getElementById('#alert-indicate');
    //removeid('#alert-indicate');
    //$('.container').removeid('#alert-indicate');
    //$(this).addid('#alert-indicate')
    //$('#btn-declaration').eq(0).removeid();
    console.log("表示します");
    judgement();
  });
}); 